# -*- coding: utf-8 -*-
# This is desing to run on colab with your own credentials, data, motor and drive acount where you have to put the motor.
# esto esta diseñado para correr en colab con tus propias credenciales, datos, motor y cuenta de drive donde debes guardar el motor
# se esta intentando desarrollar una mejora drastica con el modelo mistral-7b-instruct-v0.2.Q4_K_M.gguf, aun en analisis y pruebas
# las pruebas fueron fallidas dando con resultados inferiores, recurrire a mas pruebas
"""RAG API Jira.ipynb
...
model_path = "/content/drive/My Drive/Lexi-Llama-3-8B-Uncensored_Q4_K_M.gguf"
