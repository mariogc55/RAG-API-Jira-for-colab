...
# se esta intentando desarrollar una mejora drastica con el modelo mistral-7b-instruct-v0.2.Q4_K_M.gguf
# resultados negativos en pruebas, volviendo al motor llama temporalmente
"""RAG API Jira.ipynb
